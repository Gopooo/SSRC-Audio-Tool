...
def run_gui():
    ...
    ex_log = scrolledtext.ScrolledText(extract_tab, height=23)
    ex_log.pack(fill="both", expand=True, padx=14, pady=10)

    ex_button = ttk.Button(extract_tab, text="EXTRACT & ORGANIZE AUDIO")
    ex_button.pack(pady=(0, 14))
    ...
    rep_log = scrolledtext.ScrolledText(replace_tab, height=20)
    rep_log.pack(fill="both", expand=True, padx=14, pady=10)

    rep_button = ttk.Button(replace_tab, text="CREATE MODIFIED STREAMS2.DAT")
    rep_button.pack(pady=(0, 14))
